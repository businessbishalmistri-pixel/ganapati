        ...
        <div className="flex items-center justify-between gap-2">
          ...
          <div className="hidden sm:flex items-center gap-1.5">
            <button
              ...
              className="inline-flex items-center gap-1 px-2.5 py-1.5 text-xs font-bold text-slate-600 hover:text-slate-900 bg-slate-50 hover:bg-slate-100 border border-slate-200 rounded-xl transition-all cursor-pointer"
              title="Download CSV"
            >
            ...
            <div className="flex items-center gap-1">
              <select
                ...
                className="px-2 py-1.5 bg-slate-50 border border-slate-200 rounded-xl text-xs text-slate-700 font-medium focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500"
              >
